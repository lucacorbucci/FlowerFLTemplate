...
def prepare_celeba() -> Any:
    pass

def prepare_celeba_for_cross_silo(preferences: Preferences, partition: Any, partition_id: int) -> DataLoader:
    pass

def prepare_celeba_for_cross_device(preferences: Preferences, partition: Any, partition_id: int) -> DataLoader:
    pass